...
function App() {
	...
	const tabContentButtonClicked = (selected, configType) => {
		configType === 1 && setShowSelectedWheel(false)
		configType === 2 && setShowSelectedHandler(false)
		configType === 3 && setShowSelectedSaddle(false)
		setTimeout(() => {
			configType === 1 && setSelectedWheel(selected)
			configType === 1 && setShowSelectedWheel(true)

			configType === 2 && setSelectedHandler(selected)
			configType === 2 && setShowSelectedHandler(true)

			configType === 3 && setSelectedSaddle(selected)
			configType === 3 && setShowSelectedSaddle(true)
		}, 1000);
	}
